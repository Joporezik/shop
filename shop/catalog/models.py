...
class Order(models.Model):
    ...
    delivery_methods = models.CharField(choices=DELIVERY_METHODS,
                                        max_length=15,
                                        default='Courier')
    delivery_status = models.CharField(choices=DELIVERY_STATUSES,
                                       max_length=15,
                                       default='In process')
    delivery_notif_in_time = models.IntegerField(choices=DELIVERY_NOTIF_IM_TIME,
                                                 null=True,
                                                 default=None)
