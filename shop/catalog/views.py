...
from catalog.serializers import CategorySerializer, ProductSerializer, DiscountSerializer, \
    SellerSerializer, AddProductSerializer, BasketSerializer, DeleteProductSerializer, \
    OrderSerializer
...
class BasketView(APIView):
    ...
    def delete(self, request):
        inpust_serializer = DeleteProductSerializer(data=request.data)
        inpust_serializer.is_valid(raise_exception=True)

        product = Product.objects.get(id=inpust_serializer.data['product_id'])
